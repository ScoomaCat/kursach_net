...
/**
 * @extends ServiceEntityRepository<AppointmentStatus>
 *
...
class AppointmentStatusRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(AppointmentStatus $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(AppointmentStatus $entity, bool $flush = true): void
    {
